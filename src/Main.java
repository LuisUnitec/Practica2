...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch(opcion) {
                case 1:
                    dueñoRegistrado = new Dueño(); //Instanciado la clase Dueño
                ...
                case 2:
                    ...
                    gatoRegistrado  = new Gato();
                    gatoRegistrado.leerDatos2();
                ...
                default:
                    ...
                    System.out.println("Opción incorrecta, eliga alguna de las opciones del menu");
            }
        } while (opcion != 4);
    }
